...
const Calendario = () => {
  ...
  return (
    ...
    >
      <h2
        style={{ textAlign: "center", color: "#ff8c00", marginBottom: "1rem" }}
      >
      ...
      >
        <button
          style={navBtnStyle}
          onClick={() => setMesAtual((mesAtual + 11) % 12)}
        >
          ←
        </button>
        <button
          style={navBtnStyle}
          onClick={() => setMesAtual((mesAtual + 1) % 12)}
        >
          →
        </button>
      </div>
      ...
      >
        ...
        {[...Array(diasNoMes)].map((_, i) => (
          <DiaCalendario
            ...
            ano={anoAtual}
            onClick={() =>
              setDiaSelecionado({ dia: i + 1, mes: mesAtual, ano: anoAtual })
            }
          />
        ))}
      </div>
